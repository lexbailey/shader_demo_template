...
// Not all types are implemented here yet, just add each type as you need it
// To add a new one:
// - Create the struct like the other
// - crean an impl like the others with the gl uniform function for the type you need
// - use the uni_from! macro below to generate all the rest of it
...
impl UniformMat4{
    pub fn set(&self, data: &[GLfloat;16]){
        unsafe{
...
impl UniformVec4 {
    pub fn set(&self, r:GLfloat, g:GLfloat, b:GLfloat, a: GLfloat){
        unsafe{
...
impl UniformVec3 {
    pub fn set(&self, r:GLfloat, g:GLfloat, b:GLfloat){
        unsafe{
...
impl UniformVec2 {
    pub fn set(&self, r:GLfloat, g:GLfloat){
        unsafe{
